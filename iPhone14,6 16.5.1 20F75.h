...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a4cd208,
        .kernelcache__gPhysBase = 0xfffffff0079481a0,
        .kernelcache__gPhysSize = 0xfffffff0079481a0 + 8,
        .kernelcache__gVirtBase = 0xfffffff007946378,
        .kernelcache__perfmon_devices = 0xfffffff00a50b520,
        .kernelcache__perfmon_dev_open = 0xfffffff007f11570,
        .kernelcache__ptov_table = 0xfffffff0078fb180,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a50a990,
        .kernelcache__vm_pages = 0xfffffff0078f7ec0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0078fa130,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a50a988,
        .kernelcache__vn_kqfilter = 0xfffffff007f5e0d8,
    },
};
