...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.5.0: Thu Jun  8 17:15:35 PDT 2023; root:xnu-8796.122.5~1/RELEASE_ARM64_T8030",
        ...
        .kernelcache__cdevsw = 0xfffffff00a36d288,
        .kernelcache__gPhysBase = 0xfffffff0079280b0,
        .kernelcache__gPhysSize = 0xfffffff0079280b0 + 8,
        .kernelcache__gVirtBase = 0xfffffff007926288,
        .kernelcache__perfmon_devices = 0xfffffff00a3ab4f0,
        .kernelcache__perfmon_dev_open = 0xfffffff007ed76b8,
        .kernelcache__ptov_table = 0xfffffff0078db178,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a3aa990,
        .kernelcache__vm_pages = 0xfffffff0078d7eb0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0078da118,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a3aa988,
        .kernelcache__vn_kqfilter = 0xfffffff007f26504,
    },
};
