...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a459208,
        .kernelcache__gPhysBase = 0xfffffff0079383b8,
        .kernelcache__gPhysSize = 0xfffffff0079383b8 + 8,
        .kernelcache__gVirtBase = 0xfffffff007936570,
        .kernelcache__perfmon_devices = 0xfffffff00a499320,
        .kernelcache__perfmon_dev_open = 0xfffffff007ef0f10,
        .kernelcache__ptov_table = 0xfffffff0078eb8e8,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a498790,
        .kernelcache__vm_pages = 0xfffffff0078e8010,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0078ea898,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a498788,
        .kernelcache__vn_kqfilter = 0xfffffff007f3d5c8,
    },
};
