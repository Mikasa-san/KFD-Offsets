...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.5.0: Thu Jun  8 17:14:31 PDT 2023; root:xnu-8796.122.5~1/RELEASE_ARM64_T8020",
        ...
        .kernelcache__cdevsw = 0xfffffff00a1b1288,
        .kernelcache__gPhysBase = 0xfffffff0078dc180,
        .kernelcache__gPhysSize = 0xfffffff0078dc180 + 8,
        .kernelcache__gVirtBase = 0xfffffff0078da358,
        .kernelcache__perfmon_devices = 0xfffffff00a1ef500,
        .kernelcache__perfmon_dev_open = 0xfffffff007e59d74,
        .kernelcache__ptov_table = 0xfffffff00788f160,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a1ee990,
        .kernelcache__vm_pages = 0xfffffff00788bea8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff00788e110,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a1ee988,
        .kernelcache__vn_kqfilter = 0xfffffff007ea8bc0,
    },
};
