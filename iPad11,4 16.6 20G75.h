...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a2fd288,
        .kernelcache__gPhysBase = 0xfffffff0078f8398,
        .kernelcache__gPhysSize = 0xfffffff0078f8398 + 8,
        .kernelcache__gVirtBase = 0xfffffff0078f6550,
        .kernelcache__perfmon_devices = 0xfffffff00a33d300,
        .kernelcache__perfmon_dev_open = 0xfffffff007ea95bc,
        .kernelcache__ptov_table = 0xfffffff0078ab8c8,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a33c790,
        .kernelcache__vm_pages = 0xfffffff0078a7ff8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0078aa878,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a33c788,
        .kernelcache__vn_kqfilter = 0xfffffff007ef7f90,
    },
};
