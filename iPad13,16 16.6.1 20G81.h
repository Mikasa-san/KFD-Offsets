...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffe000aa19288,
        .kernelcache__gPhysBase = 0xfffffe0007a683b8,
        .kernelcache__gPhysSize = 0xfffffe0007a683b8 + 8,
        .kernelcache__gVirtBase = 0xfffffe0007a66570,
        .kernelcache__perfmon_devices = 0xfffffe000aa59320,
        .kernelcache__perfmon_dev_open = 0xfffffe00080b805c,
        .kernelcache__ptov_table = 0xfffffe00079b38f0,
        .kernelcache__vm_first_phys_ppnum = 0xfffffe000aa58790,
        .kernelcache__vm_pages = 0xfffffe00079b0008,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffe00079b2890,
        .kernelcache__vm_page_array_ending_addr = 0xfffffe000aa58788,
        .kernelcache__vn_kqfilter = 0xfffffe0008106d2c,
    },
};
