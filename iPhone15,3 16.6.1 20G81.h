...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.6.0: Wed Jun 28 20:51:46 PDT 2023; root:xnu-8796.142.1~1/RELEASE_ARM64_T8120",
        ...
        .kernelcache__gPhysBase = 0xfffffff0079382c8,
        .kernelcache__gPhysSize = 0xfffffff0079382c8 + 8,
        .kernelcache__gVirtBase = 0xfffffff007936480,
        .kernelcache__perfmon_devices = 0xfffffff00a465300,
        .kernelcache__perfmon_dev_open = 0xfffffff007ef0a30,
        .kernelcache__ptov_table = 0xfffffff0078eb8e0,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a464790,
        .kernelcache__vm_pages = 0xfffffff0078e8008,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0078ea890,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a464788,
        .kernelcache__vn_kqfilter = 0xfffffff007f3d0e8,
    },
};
