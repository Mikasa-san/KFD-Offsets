...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.5.0: Thu Jun  8 17:14:33 PDT 2023; root:xnu-8796.122.5~1/RELEASE_ARM64_T8110",
        ...
        .kernelcache__cdevsw = 0xfffffff00a76d208,
        .kernelcache__gPhysBase = 0xfffffff0079981a0,
        .kernelcache__gPhysSize = 0xfffffff0079981a0 + 8,
        .kernelcache__gVirtBase = 0xfffffff007996378,
        .kernelcache__perfmon_devices = 0xfffffff00a7ab520,
        .kernelcache__perfmon_dev_open = 0xfffffff007fc9570,
        .kernelcache__ptov_table = 0xfffffff00794b180,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a7aa990,
        .kernelcache__vm_pages = 0xfffffff007947ec0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff00794a130,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a7aa988,
        .kernelcache__vn_kqfilter = 0xfffffff0080160d8,
    },
};
