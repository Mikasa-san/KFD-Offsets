...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__gPhysBase = 0xfffffff0079203b8,
        .kernelcache__gPhysSize = 0xfffffff0079203b8 + 8,
        .kernelcache__gVirtBase = 0xfffffff00791e570,
        .kernelcache__perfmon_devices = 0xfffffff00a4e5320,
        .kernelcache__perfmon_dev_open = 0xfffffff007f0c278,
        .kernelcache__ptov_table = 0xfffffff0078d38f0,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a4e4790,
        .kernelcache__vm_pages = 0xfffffff0078d0008,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0078d2890,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a4e4788,
