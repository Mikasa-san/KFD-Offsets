...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.6.0: Wed Jun 28 20:51:42 PDT 2023; root:xnu-8796.142.1~1/RELEASE_ARM64_T8020",
        ...
        .kernelcache__cdevsw = 0xfffffff00a1bd288,
        .kernelcache__gPhysBase = 0xfffffff0078dc398,
        .kernelcache__gPhysSize = 0xfffffff0078dc398 + 8,
        .kernelcache__gVirtBase = 0xfffffff0078da550,
        .kernelcache__perfmon_devices = 0xfffffff00a1fd300,
        .kernelcache__perfmon_dev_open = 0xfffffff007e595bc,
        .kernelcache__ptov_table = 0xfffffff00788f8c8,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a1fc790,
        .kernelcache__vm_pages = 0xfffffff00788bff8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff00788e878,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a1fc788,
        .kernelcache__vn_kqfilter = 0xfffffff007ea7f90,
    },
};
