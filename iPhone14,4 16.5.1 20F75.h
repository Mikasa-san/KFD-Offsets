...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__gPhysBase = 0xfffffff00793c1a0,
        .kernelcache__gPhysSize = 0xfffffff00793c1a0 + 8,
        .kernelcache__gVirtBase = 0xfffffff00793a378,
        .kernelcache__perfmon_devices = 0xfffffff00a4af520,
        .kernelcache__perfmon_dev_open = 0xfffffff007efd570,
        ...
        .kernelcache__vn_kqfilter = 0xfffffff007f4a0d8,
    },
};
