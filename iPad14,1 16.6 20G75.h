...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a78d208,
        .kernelcache__gPhysBase = 0xfffffff00799c3b8,
        .kernelcache__gPhysSize = 0xfffffff00799c3b8 + 8,
        .kernelcache__gVirtBase = 0xfffffff00799a570,
        .kernelcache__perfmon_devices = 0xfffffff00a7cd320,
        .kernelcache__perfmon_dev_open = 0xfffffff007fdcf10,
        .kernelcache__ptov_table = 0xfffffff00794f8e8,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a7cc790,
        .kernelcache__vm_pages = 0xfffffff00794c010,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff00794e898,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a7cc788,
        .kernelcache__vn_kqfilter = 0xfffffff0080295c8,
    },
};
