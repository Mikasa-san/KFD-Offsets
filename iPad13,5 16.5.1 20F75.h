...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffe000aad5288,
        .kernelcache__gPhysBase = 0xfffffe0007a841a0,
        .kernelcache__gPhysSize = 0xfffffe0007a841a0 + 8,
        .kernelcache__gVirtBase = 0xfffffe0007a82378,
        .kernelcache__perfmon_devices = 0xfffffe000ab13520,
        .kernelcache__perfmon_dev_open = 0xfffffe00080d4728,
        .kernelcache__ptov_table = 0xfffffe00079cf188,
        .kernelcache__vm_first_phys_ppnum = 0xfffffe000ab12990,
        .kernelcache__vm_pages = 0xfffffe00079cbeb8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffe00079ce128,
        .kernelcache__vm_page_array_ending_addr = 0xfffffe000ab12988,
        .kernelcache__vn_kqfilter = 0xfffffe00081238b4,
    },
};
