...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a4dd208,
        .kernelcache__gPhysBase = 0xfffffff00794c3b8,
        .kernelcache__gPhysSize = 0xfffffff00794c3b8 + 8,
        .kernelcache__gVirtBase = 0xfffffff00794a570,
        .kernelcache__perfmon_devices = 0xfffffff00a51d320,
        .kernelcache__perfmon_dev_open = 0xfffffff007f14f10,
        .kernelcache__ptov_table = 0xfffffff0078ff8e8,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a51c790,
        .kernelcache__vm_pages = 0xfffffff0078fc010,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0078fe898,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a51c788,
        .kernelcache__vn_kqfilter = 0xfffffff007f615c8,
    },
};
