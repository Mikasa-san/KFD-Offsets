...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a1a5288,
        .kernelcache__gPhysBase = 0xfffffff0078c8180,
        .kernelcache__gPhysSize = 0xfffffff0078c8180 + 8,
        .kernelcache__gVirtBase = 0xfffffff0078c6358,
        .kernelcache__perfmon_devices = 0xfffffff00a1e3500,
        .kernelcache__perfmon_dev_open = 0xfffffff007e59d74,
        .kernelcache__ptov_table = 0xfffffff00787b160,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a1e2990,
        .kernelcache__vm_pages = 0xfffffff007877ea8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff00787a110,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a1e2988,
