...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__gPhysBase = 0xfffffff0079381a0,
        .kernelcache__gPhysSize = 0xfffffff0079381a0 + 8,
        .kernelcache__gVirtBase = 0xfffffff007936378,
        .kernelcache__perfmon_devices = 0xfffffff00a48b520,
        .kernelcache__perfmon_dev_open = 0xfffffff007ef1570,
        ...
        .kernelcache__vn_kqfilter = 0xfffffff007f3e0d8,
    },
};
