...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.5.0: Thu Jun  8 17:13:54 PDT 2023; root:xnu-8796.122.5~1/RELEASE_ARM64_T8101",
        ...
        .kernelcache__cdevsw = 0xfffffff00a499288,
        .kernelcache__gPhysBase = 0xfffffff0079201a0,
        .kernelcache__gPhysSize = 0xfffffff0079201a0 + 8,
        .kernelcache__gVirtBase = 0xfffffff00791e378,
        .kernelcache__perfmon_devices = 0xfffffff00a4d7520,
        .kernelcache__perfmon_dev_open = 0xfffffff007f0c934,
        .kernelcache__ptov_table = 0xfffffff0078d3188,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a4d6990,
        .kernelcache__vm_pages = 0xfffffff0078cfeb8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0078d2128,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a4d6988,
        .kernelcache__vn_kqfilter = 0xfffffff007f5bab8,
    },
};
