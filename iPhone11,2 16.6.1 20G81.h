...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a31d288,
        .kernelcache__gPhysBase = 0xfffffff0078fc398,
        .kernelcache__gPhysSize = 0xfffffff0078fc398 + 8,
        .kernelcache__gVirtBase = 0xfffffff0078fa550,
        .kernelcache__perfmon_devices = 0xfffffff00a35d300,
        .kernelcache__perfmon_dev_open = 0xfffffff007e9d5bc,
        .kernelcache__ptov_table = 0xfffffff0078af8c8,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a35c790,
        .kernelcache__vm_pages = 0xfffffff0078abff8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0078ae878,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a35c788,
        .kernelcache__vn_kqfilter = 0xfffffff007eebf90,
    },
};
