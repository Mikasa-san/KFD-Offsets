...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__gPhysBase = 0xfffffff00791c3b8,
        .kernelcache__gPhysSize = 0xfffffff00791c3b8 + 8,
        .kernelcache__gVirtBase = 0xfffffff00791a570,
        .kernelcache__perfmon_devices = 0xfffffff00a4d9320,
        .kernelcache__perfmon_dev_open = 0xfffffff007f0c278,
        .kernelcache__ptov_table = 0xfffffff0078cf8f0,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a4d8790,
        .kernelcache__vm_pages = 0xfffffff0078cc008,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0078ce890,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a4d8788,
        .kernelcache__vn_kqfilter = 0xfffffff007f5af40,
    },
};
