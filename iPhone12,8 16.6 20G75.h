...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__gPhysBase = 0xfffffff0079402c8,
        .kernelcache__gPhysSize = 0xfffffff0079402c8 + 8,
        .kernelcache__gVirtBase = 0xfffffff00793e480,
        .kernelcache__perfmon_devices = 0xfffffff00a4312f0,
        .kernelcache__perfmon_dev_open = 0xfffffff007ee2f00,
        .kernelcache__ptov_table = 0xfffffff0078f38e0,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a430790,
        .kernelcache__vm_pages = 0xfffffff0078f0000,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0078f2880,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a430788,
        .kernelcache__vn_kqfilter = 0xfffffff007f318d4,
    },
};
