...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a37d288,
        .kernelcache__gPhysBase = 0xfffffff00792c2c8,
        .kernelcache__gPhysSize = 0xfffffff00792c2c8 + 8,
        .kernelcache__gVirtBase = 0xfffffff00792a480,
        .kernelcache__perfmon_devices = 0xfffffff00a3bd2f0,
        .kernelcache__perfmon_dev_open = 0xfffffff007edaf00,
        .kernelcache__ptov_table = 0xfffffff0078df8e0,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a3bc790,
        .kernelcache__vm_pages = 0xfffffff0078dc000,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0078de880,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a3bc788,
        .kernelcache__vn_kqfilter = 0xfffffff007f298d4,
    },
};
