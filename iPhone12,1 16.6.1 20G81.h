...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.6.0: Wed Jun 28 20:51:23 PDT 2023; root:xnu-8796.142.1~1/RELEASE_ARM64_T8030",
        ...
        .kernelcache__cdevsw = 0xfffffff00a43d288,
        .kernelcache__gPhysBase = 0xfffffff0079502c8,
        .kernelcache__gPhysSize = 0xfffffff0079502c8 + 8,
        .kernelcache__gVirtBase = 0xfffffff00794e480,
        .kernelcache__perfmon_devices = 0xfffffff00a47d2f0,
        .kernelcache__perfmon_dev_open = 0xfffffff007efaf00,
        .kernelcache__ptov_table = 0xfffffff0079038e0,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a47c790,
        .kernelcache__vm_pages = 0xfffffff007900000,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007902880,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a47c788,
        .kernelcache__vn_kqfilter = 0xfffffff007f498d4,
    },
};
