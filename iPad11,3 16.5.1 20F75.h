...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a2f1288,
        .kernelcache__gPhysBase = 0xfffffff0078f8180,
        .kernelcache__gPhysSize = 0xfffffff0078f8180 + 8,
        .kernelcache__gVirtBase = 0xfffffff0078f6358,
        .kernelcache__perfmon_devices = 0xfffffff00a32f500,
        .kernelcache__perfmon_dev_open = 0xfffffff007ea9d74,
        .kernelcache__ptov_table = 0xfffffff0078ab160,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a32e990,
        .kernelcache__vm_pages = 0xfffffff0078a7ea8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0078aa110,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a32e988,
        .kernelcache__vn_kqfilter = 0xfffffff007ef8bc0,
    },
};
