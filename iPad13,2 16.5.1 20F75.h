...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a48d288,
        .kernelcache__gPhysBase = 0xfffffff00791c1a0,
        .kernelcache__gPhysSize = 0xfffffff00791c1a0 + 8,
        .kernelcache__gVirtBase = 0xfffffff00791a378,
        .kernelcache__perfmon_devices = 0xfffffff00a4cb520,
        .kernelcache__perfmon_dev_open = 0xfffffff007f0c934,
        .kernelcache__ptov_table = 0xfffffff0078cf188,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a4ca990,
        .kernelcache__vm_pages = 0xfffffff0078cbeb8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0078ce128,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a4ca988,
