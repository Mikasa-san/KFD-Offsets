...
const struct dynamic_info kern_versions[] = {
    {
        .kern_version = "Darwin Kernel Version 22.5.0: Thu Jun  8 17:15:24 PDT 2023; root:xnu-8796.122.5~1/RELEASE_ARM64_T8103",
        ...
        .kernelcache__cdevsw = 0xfffffe000a9f9288,
        .kernelcache__gPhysBase = 0xfffffe0007a641a0,
        .kernelcache__gPhysSize = 0xfffffe0007a641a0 + 8,
        .kernelcache__gVirtBase = 0xfffffe0007a62378,
        .kernelcache__perfmon_devices = 0xfffffe000aa37520,
        .kernelcache__perfmon_dev_open = 0xfffffe00080a4728,
        .kernelcache__ptov_table = 0xfffffe00079af188,
        .kernelcache__vm_first_phys_ppnum = 0xfffffe000aa36990,
        .kernelcache__vm_pages = 0xfffffe00079abeb8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffe00079ae128,
        .kernelcache__vm_page_array_ending_addr = 0xfffffe000aa36988,
        .kernelcache__vn_kqfilter = 0xfffffe00080f38b4,
    },
};
