...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a1b5288,
        .kernelcache__gPhysBase = 0xfffffff0078c8398,
        .kernelcache__gPhysSize = 0xfffffff0078c8398 + 8,
        .kernelcache__gVirtBase = 0xfffffff0078c6550,
        .kernelcache__perfmon_devices = 0xfffffff00a1f5300,
        .kernelcache__perfmon_dev_open = 0xfffffff007e5d5bc,
        .kernelcache__ptov_table = 0xfffffff00787b8c8,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a1f4790,
        .kernelcache__vm_pages = 0xfffffff007877ff8,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff00787a878,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a1f4788,
        .kernelcache__vn_kqfilter = 0xfffffff007eabf90,
    },
};
