...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a479208,
        .kernelcache__gPhysBase = 0xfffffff00793c3b8,
        .kernelcache__gPhysSize = 0xfffffff00793c3b8 + 8,
        .kernelcache__gVirtBase = 0xfffffff00793a570,
        .kernelcache__perfmon_devices = 0xfffffff00a4b9320,
        .kernelcache__perfmon_dev_open = 0xfffffff007efcf10,
        .kernelcache__ptov_table = 0xfffffff0078ef8e8,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a4b8790,
        .kernelcache__vm_pages = 0xfffffff0078ec010,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0078ee898,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a4b8788,
        .kernelcache__vn_kqfilter = 0xfffffff007f495c8,
    },
};
