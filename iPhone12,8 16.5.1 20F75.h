...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a3e5288,
        .kernelcache__gPhysBase = 0xfffffff0079400b0,
        .kernelcache__gPhysSize = 0xfffffff0079400b0 + 8,
        .kernelcache__gVirtBase = 0xfffffff00793e288,
        .kernelcache__perfmon_devices = 0xfffffff00a4234f0,
        .kernelcache__perfmon_dev_open = 0xfffffff007ee36b8,
        .kernelcache__ptov_table = 0xfffffff0078f3178,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a422990,
        .kernelcache__vm_pages = 0xfffffff0078efeb0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff0078f2118,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a422988,
        .kernelcache__vn_kqfilter = 0xfffffff007f32504,
    },
};
