...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__cdevsw = 0xfffffff00a431288,
        .kernelcache__gPhysBase = 0xfffffff0079500b0,
        .kernelcache__gPhysSize = 0xfffffff0079500b0 + 8,
        .kernelcache__gVirtBase = 0xfffffff00794e288,
        .kernelcache__perfmon_devices = 0xfffffff00a46f4f0,
        .kernelcache__perfmon_dev_open = 0xfffffff007efb6b8,
        .kernelcache__ptov_table = 0xfffffff007903178,
        .kernelcache__vm_first_phys_ppnum = 0xfffffff00a46e990,
        .kernelcache__vm_pages = 0xfffffff0078ffeb0,
        .kernelcache__vm_page_array_beginning_addr = 0xfffffff007902118,
        .kernelcache__vm_page_array_ending_addr = 0xfffffff00a46e988,
        .kernelcache__vn_kqfilter = 0xfffffff007f4a504,
    },
};
