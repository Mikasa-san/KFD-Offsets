...
const struct dynamic_info kern_versions[] = {
    {
        ...
        .kernelcache__gPhysBase = 0xfffffff0079301a0,
        .kernelcache__gPhysSize = 0xfffffff0079301a0 + 8,
        .kernelcache__gVirtBase = 0xfffffff00792e378,
        .kernelcache__perfmon_devices = 0xfffffff00a4db520,
        .kernelcache__perfmon_dev_open = 0xfffffff007ef4934,
        ...
        .kernelcache__vn_kqfilter = 0xfffffff007f43ab8,
    },
};
